...
export const NetworkGraph: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-full bg-slate-100/70 dark:bg-slate-950 overflow-hidden flex flex-col select-none transition-colors">
      ...
      <div className="absolute top-3 left-3 z-20 flex items-center space-x-2 bg-white/95 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 backdrop-blur-md p-1.5 rounded-xl shadow-md transition-colors">
        <div className="flex items-center space-x-1 border-r border-slate-200 dark:border-slate-800 pr-2 mr-1">
          ...
          <span className="text-[11px] font-mono text-slate-500 dark:text-slate-400 font-bold">View:</span>
          <button
      ...
      <div className="absolute top-3 right-3 z-20 flex flex-col items-end space-y-1.5 pointer-events-none">
        <div className="bg-white/95 dark:bg-slate-900/90 border border-slate-200 dark:border-slate-800 backdrop-blur-md px-3.5 py-2 rounded-xl shadow-md text-[10px] flex flex-wrap items-center gap-x-3.5 gap-y-1 text-slate-700 dark:text-slate-300 font-mono pointer-events-auto transition-colors">
        ...
        <div className="text-[10px] font-mono text-slate-600 dark:text-slate-400 bg-white/90 dark:bg-slate-950/80 px-3 py-1 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">
